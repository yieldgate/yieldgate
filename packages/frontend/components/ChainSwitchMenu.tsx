  ...
  return (
    <>
      <Menu>
        ...
        <MenuList>
          {!!mainnets?.length && (
            <ChainsMenuGroup chains={mainnets} title="Mainnets" />
          )}
          {!!testnets?.length && (
            <ChainsMenuGroup chains={testnets} title="Testnets" />
          )}
        </MenuList>
      </Menu>
    </>
